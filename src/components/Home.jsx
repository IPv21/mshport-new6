...
const Home = () => {
  ...
  <div class="wrapper">
    ...
    <span class="shadow"></span>
            ...
            <p className='text-gray-300 py-4 max-w-[700px] font-bold'>I'm a Full Stack Developer specializing in designing stylish digital experiences and responsive web applications and bringing them to life. </p>
            <div>
