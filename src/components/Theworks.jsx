    ...
    <div name='theworks' className='pt-[60px] vh-100% sm:pl-[75px] w-full  bg-[#1b0e45] text-gray-300'>
        <div className=' max-w-[1000px] mx-auto p-6 flex flex-col justify-center w-full h-full'>
           <div className='pb-10'>
            ...
            <div className="card" style={{ backgroundImage: `url(${firstsite})`, backgroundSize: 'cover' }}>
                <div className="card__content">
                 <p className="card__title">My First Site</p>
                 <p className="card__description"> This is my first site that I built using HTML, CSS, and JavaScript. It is a simple site that showcases just how far I have come in my coding journey.

                 </p>
                 <a href="https://ipv21.github.io/chal2/">
                 <button class="btn-23">
                   <span class="text"></span>
                   <span class="marquee">LOL</span> 
                 </button>
                    </a>
                </div>
            </div>
